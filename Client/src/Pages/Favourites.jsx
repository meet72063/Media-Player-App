        ...
        <div className=' mt-4 ml-2'>
          <div className='flex space-y-1'>
            ...
            <div className='ml-4 pr-10'>
             ...
             {favouritePlaylist.length>0 ? <h2>these are your favourite songs</h2>:<h2 className='mt-2'>Your favourite playlist is Empty</h2> }

            </div>

          </div>
         {favouritePlaylist.length>0 && <div className='mt-10 flex gap-x-12 border-b-gray-700 border-b-[0.3px] pb-5 mr-10' >
             <h1 className='sm:text-3xl text-xl ml-4'>{favouritePlaylist.length} Songs</h1>
