...
const Modal = () => {
  ...
  return (
    <div className=' w-[100%] grid place-content-center fixed  z-20 h-screen  bg-[rgba(0,0,0,0.7)] shadow-lg' onClick={()=>dispatch(setOpenModal(false))} >
      ...
      <button onClick={()=>dispatch(setOpenModal(false))} className=' text-xl font-semibold hover:text-[23px] absolute right-4'>x</button>
